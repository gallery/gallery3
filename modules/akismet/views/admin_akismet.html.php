...
<div id="g-admin-akismet" class="g-block">
  ...
  <div class="g-block-content">
    ...
    <div class="g-module-status g-success">
      <?php echo t("Your API key is valid.  Your comments will be filtered!") ?>
    </div>
    <?php endif ?>
