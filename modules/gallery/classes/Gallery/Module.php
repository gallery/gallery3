...
class Gallery_Module {
  ...
  static function can_activate($module_name) {
    ...
    $installer_class = "Hook_" . Inflector::camelize($module->name, true) . "Installer";
  ...
  static function event($name, &$data=null) {
    ...
    foreach (self::$active as $module) {
      ...
      $class = "Hook_" . Inflector::camelize($module->name, true) . "Event";
    ...
    if (Theme::$is_admin) {
      $class = "Hook_" . Inflector::camelize(Theme::$admin_theme_name, true) . "Event";
      if (class_exists($class) && method_exists($class, $function)) {
        call_user_func_array(array($class, $function), $args);
      }
    }
    ...
    $class = "Hook_" . Inflector::camelize(Theme::$site_theme_name, true) . "Event";
    if (class_exists($class) && method_exists($class, $function)) {
      call_user_func_array(array($class, $function), $args);
    }
  }
