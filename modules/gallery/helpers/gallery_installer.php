...
class gallery_installer {
  ...
  static function upgrade($version) {
    ...
    if ($version == 53) {
      ...
      // album covers taken from non-jpg photos had incorrect extensions and that copies of 
      // missing_movie and missing_photo could have incorrect extensions. The changes in this 
      // version ensure that this will not occur in the future, and the code below corrects all 
      // mis-named album thumbnails (but does not attempt to fix copies of missing_movie and
      // missing_photo).  Additionally, by defining these independently, we can change them (e.g.
      // to make all thumbnails into jpg for fast page loads).
