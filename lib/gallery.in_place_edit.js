(function($) {
  $.widget("ui.gallery_in_place_edit", {
    ...
    _setup_form: function(form) {
      ...
      if ($("#g-in-place-edit-form .submit").length) {
        $("#g-in-place-edit-form .submit").addClass("ui-state-default");
        $("#g-in-place-edit-form .submit").parent().append(eCancel);
        $("#g-in-place-edit-form .g-cancel").click(function(event) {
          self._cancel();
          event.preventDefault();
          return false;
        });
